    ...
    <div>
      <el-input size="mini" placeholder="请选择用户" :disabled="disableBool" v-model="userStr" class="input-with-select" @focus="enableinputHandle">
        <div slot="append" v-if="!disableBool">
          <zebra-button icon="el-icon-search" type="info" :disabled="disableBool" @click="openDialog"></zebra-button>
          <zebra-button icon="el-icon-delete" type="warning" :disabled="disableBool" @click="clearUser"></zebra-button>
        </div>
      </el-input>
    </div>
    <el-dialog
...
export default {
  ...
  methods: {
    ...
    submit () {
      ...
      // this.$emit('formChange', this.form[this.prop])
...
.table-form .zebra-table .el-table{
  .user-info-list{
    .input-with-select{
