  ...
  <div class="datasource-info-list">
    <div>
      <el-input size="mini" placeholder="请选择数据" :disabled="disabled" v-model="userStr" class="input-with-select" @focus="enableinputHandle">
        <div slot="append" v-if="!disabled">
          <zebra-button icon="el-icon-search" type="info" :disabled="disabled" @click="openDialog"></zebra-button>
          <zebra-button icon="el-icon-delete" type="warning" :disabled="disabled" @click="clearUser"></zebra-button>
        </div>
      </el-input>
    </div>
    <el-dialog
    ...
    >
      <div class="datasource-info-box">
        ...
        >
          <template slot="headerTop">
            <zebra-form :option="queryOption" :formData="queryParams" @submit="searchChange"></zebra-form>
          </template>
      ...
      <el-row style="display:flex;justify-content:center;align-items:center;">
        <zebra-button size="mini" type="primary" @click="submit">确定</zebra-button>
        <zebra-button size="mini" @click="cancel">取消</zebra-button>
      </el-row>
    </el-dialog>
  </div>
</template>
